...
test('You tab shows a login/signup form when logged out', async ({ page }) => {
...
test('sign up, see real order history state, log out, log back in', async ({ page }) => {
...
test('logging in with the wrong password shows an inline error, not a silent failure', async ({ page }) => {
