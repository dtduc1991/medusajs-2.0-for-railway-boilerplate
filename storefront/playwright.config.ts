...
export default defineConfig({
  ...
  projects: [
...

    {
      ...
      testIgnore: ["public/checkout-railway.spec.ts", "public/register-railway.spec.ts", "public/login-railway.spec.ts", "public/discount-railway.spec.ts"],
     ...
     * `NEXT_PUBLIC_BASE_URL=<deployed storefront URL> npm run test-e2e:railway`. */
    {
      ...
      testMatch: ["public/checkout-railway.spec.ts", "public/register-railway.spec.ts", "public/login-railway.spec.ts", "public/discount-railway.spec.ts"],
      use: { ...devices["Desktop Chrome"] },
    },
